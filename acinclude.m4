...
then
     CFLAGS="-Wall -O3 -DHAVE_INTTYPES_H -DHAVE_NETINET_IN_H"
     CXXFLAGS="-Wall -O3 -DHAVE_INTTYPES_H -DHAVE_NETINET_IN_H"
else
     CFLAGS="-Wall -g -DHAVE_INTTYPES_H -DHAVE_NETINET_IN_H"
     CXXFLAGS="-Wall -g -DHAVE_INTTYPES_H -DHAVE_NETINET_IN_H"
fi
